...
do { 
   ...
   switch (opción)
	   {  case 1:
        	 ...
        	 break;
         case 2:
        	 procesando_Rectángulo(teclado, x, y);
        	 break;
         case 3:
        	 procesando_Cuadrado(teclado, x, y);
	         break;
        }
   }
}while (opción != 4); 
...
private static void procesando_Cuadrado(Scanner teclado, double x, double y) {
...
private static void procesando_Rectángulo(Scanner teclado, double x, double y) {
